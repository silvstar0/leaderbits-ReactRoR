...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'leaderbits-staging.herokuapp.com' }
  config.action_mailer.asset_host = "https://leaderbits-staging.herokuapp.com"
